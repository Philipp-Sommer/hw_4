...
class TestFakeNewsGenerator(unittest.TestCase):
    ...
    def test_female_credit(self):
        actual = fake_news_generator.fake_news(fake_news_generator.WORD_LIST,
                                               seed=1)
        self.assertEqual(actual, 'According to Sarah Gallagher the rates '
                         'talked numbers. Russia thank China of poll.')
...
class TestCountUnique(unittest.TestCase):
    target = "count_unique.py"
    points = 4

    def test_empty(self):
        self.assertEqual(count_unique.unique_words([]), {})
    ...
    def test_count_lower(self):
        ...
        expected = {"design": 3,
                    ...
                    "for": 3,
                    "services": 3}
        self.assertDictEqual(count_unique.unique_words(words), expected)
    ...
    def test_count_sorted(self):
        ...
        expected = [Pair("design", 3),
                    ...
                    Pair("for", 3),
                    Pair("services", 3)]
        self.assertEqual(count_unique.count_unique_sorted(words), expected)
